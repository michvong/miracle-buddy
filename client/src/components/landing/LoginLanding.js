            ...
            <div className="text-center pb-12 md:pb-16">
                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center" data-aos="zoom-y-out" data-aos-delay="300">
                        <div className="px-4 ">
                            <Button className="bg-blue" variant="gradient">Regular user</Button>
                            {/* <a className="text-white bg-blue-500 hover:bg-blue-700 w-full mb-4 sm:w-auto sm:mb-0" href="#0">Regular user</a> */}
                        </div>
                        <div className="px-4">
                            <Button className="bg-black" variant="filled">Company user</Button> 
                            {/* <a className="text-white bg-black hover:bg-gray-800 w-full sm:w-auto sm:ml-4" href="#0">Company user</a> */}
                        </div>
                    </div>
                </div>
            </div>
